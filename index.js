...
xhr.open('GET', 'https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=dbd85ef8729940fc9e7e103a6af7f1bc',true);
        ...
        article.forEach(function(element,index){
            let news=`<div class="accordion-item">
                            ...
                            <div id="collapse${index}" class="accordion-collapse collapse" aria-labelledby="heading${index}"
                                ...
                                ${element["content"]}.<a href="${element['url']}" traget="_blank"> Read more here</a>
